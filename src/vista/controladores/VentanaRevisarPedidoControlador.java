...
public class VentanaRevisarPedidoControlador {
    ...
    public void initialize() {
        ...
        Pedido pedido = pizzeria.getPedidos()
        .get(pizzeria.getPedidos().size() - 1);
    ...
    private void handleContinuar() {
        try {
            ...
            controlador.setPedido(pizzeria.getPedidos().get(pizzeria.getPedidos().size() - 1));
    ...
    private void handleEliminar() {
        ...
        if(confirmacion.getResult() == ButtonType.YES){
            ...
            Pedido pedido = pizzeria.getPedidos().get(pizzeria.getPedidos().size() - 1);
